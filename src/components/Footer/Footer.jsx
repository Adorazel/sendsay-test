...
const Footer = props => {
  ...
  const {sendRequest, isLoading,  format} = props


  return <footer className="footer">
    <div className="footer__left">
      <Button onClick={sendRequest} loading={isLoading} >Отправить</Button>
    </div>
    <div className="footer__center">
      <Copyright/>
    </div>
    <div className="footer__right">
      <Button variant="simple" onClick={format} loading={isLoading}>
